    ...
    <div className="min-h-screen w-full flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-2xl max-w-lg shadow-2xl">
            ...
            <p className="text-white/70 leading-relaxed mb-6">
              Manage your AI-powered voice agents, monitor real-time conversations, and optimize customer interactions — all from one dashboard.
            </p>

            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm text-white/60">
                <div className="h-2 w-2 rounded-full bg-green-400" />
                <span>AI-Powered Voice Bots</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-white/60">
                <div className="h-2 w-2 rounded-full bg-green-400" />
